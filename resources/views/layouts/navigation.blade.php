<nav x-data="{ open: false }" class="bg-[#064b31] border-b-4 border-[#ff7a00] shadow-sm">
        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-green-50 bg-[#064b31] hover:text-white focus:outline-none transition ease-in-out duration-150">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1 bg-[#064b31]">
        ...
        <div class="pt-4 pb-1 border-t border-[#0c5f3a] bg-[#064b31]">
            <div class="px-4">
