    ...
    >
        ...
        >
            <div
                x-show="whatsappModalOpen"
                x-transition
                x-on:click.outside="closeWhatsappModal()"
            ...
            >
                ...
                <button
                    type="button"
                    role="checkbox"
                    x-bind:aria-checked="whatsappAbrirSgp.toString()"
                ...
                >
                    ...
                    >
                        <svg
                            class="h-4 w-4 text-white transition-opacity"
                            x-bind:class="whatsappAbrirSgp ? 'opacity-100' : 'opacity-0'"
                            viewBox="0 0 20 20"
                            fill="currentColor"
                            aria-hidden="true"
                        >
                            <path fill-rule="evenodd" d="M16.704 5.29a1 1 0 0 1 .006 1.414l-7.25 7.3a1 1 0 0 1-1.42.006L3.29 9.29a1 1 0 1 1 1.42-1.41l3.03 3.05 6.54-6.58a1 1 0 0 1 1.414-.06Z" clip-rule="evenodd"/>
                        </svg>
                    </span>
                ...
                >
                    ...
                    <button
                        type="submit"
                        x-bind:disabled="!whatsappReady"
                        x-bind:class="whatsappReady ? 'bg-[#ff7a00] hover:bg-[#e96c00] text-white' : 'cursor-not-allowed bg-[#ff7a00]/50 text-white/80'"
